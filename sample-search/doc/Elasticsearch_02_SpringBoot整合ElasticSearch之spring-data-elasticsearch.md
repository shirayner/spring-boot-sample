# Elasticsearch_02_SpringBoot整合ElasticSearch之spring-data-elasticsearch
...
> - **REST Client** ：上面的方式1是基于TCP和ES通信的(而且TransPort将来会被抛弃……)，官方也给出了基于HTTP的客户端REST Client(推荐使用)，官方给出来的REST Client有Java Low Level REST Client和Java Hight Level REST Client两个，前者兼容所有版本的ES，后者是基于前者开发出来的，只暴露了部分API，待完善
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>sample-spring-data-elasticsearch</artifactId>
...
> - [elasticsearch入门 springboot2集成elasticsearch 实现全文搜索,图文讲解带源码](https://juejin.im/post/5c9700956fb9a0710c703e06)
> - [ElasticSearch(2)---SpringBoot整合ElasticSearch](https://www.cnblogs.com/qdhxhz/p/9521065.html)
